...
class CardHorizontal extends StatelessWidget {
  ...
  static void defaultFunc(BuildContext context, Survey survey,
      String? surveyKeys, bool isDetailSurvey) {
    if (isDetailSurvey) {
      Navigator.push(
        context,
        MaterialPageRoute(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(title,
                          style:
                              TextStyle(color: NowUIColors.text, fontSize: 16)),
                      GestureDetector(
                        onTap: () {
                          defaultFunc(menuScreenContext, survey, surveyKeys,
                              isDetailSurveyPage);
                        },
                        child: Text(cta,
                            style: TextStyle(
